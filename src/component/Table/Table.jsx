    ...
    <div className="table-container">
      ...
      <div className="table-data-container">
        <div className="table-rows-data-container">
          ...
          <div className="table-col">9717167563</div>
          <div className="table-col red">-25.966 Gm</div>
          <div className="table-col red">-14.200 Kg</div>
          <div className="table-col green">+₹1,850.00</div>
          <div className="table-col">
            <div className="table-col-actions">
              <div className="table-edit table-action-btn">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              <div className="table-delete table-action-btn">
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
